...
export default {
    ...
    theme: {
        extend: {
            ...
            colors: {
                primary: {
                    DEFAULT: '#2c90ce', // Define your primary color here
            ...
            border413Para definir a cor primária como `#2c90ce` no seu arquivo de configuração do Tailwind CSS e garantir que ela seja aplicada aos botões e outros elementos, você precisará atualizar a configuração do Tailwind e ajustar o componente Blade para utilizar essa cor. Vamos ver como fazer isso em detalhes:

### Passo 1: Atualizar a Configuração do Tailwind CSS

Edite a configuração do Tailwind CSS para definir a cor primária como `#2c90ce`.
