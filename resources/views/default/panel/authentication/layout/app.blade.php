        ...
        <div class="flex-grow">
            <a class="navbar-brand" href="{{ route('index') }}">
                @if (isset($setting->logo_dashboard))
                    <img
                        class="group-[.navbar-shrinked]/body:hidden dark:hidden w-32 h-auto" {{-- Ajuste o tamanho conforme necessário --}}
                    ...
                    >
                    <img
                        class="hidden group-[.navbar-shrinked]/body:hidden dark:block w-32 h-auto" {{-- Ajuste o tamanho conforme necessário --}}
